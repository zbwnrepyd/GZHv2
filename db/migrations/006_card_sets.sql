...
VALUES
('v2','v2_card_01',1,'封面',
 '{"fields":["company_name","company_type"],"media":["logo"],"template_id":"cover_default"}'),
('v2','v2_card_02',2,'公司概览',
 '{"fields":["company_def","location","funding_info","main_product_name","main_product_highlight","main_product_achievement","arr","registered_users","website_url"],"media":["website_screenshot"],"template_id":"overview_v2"}'),
('v2','v2_card_03',3,'产品与定位',
 '{"fields":["ecosystem_positioning","differentiation_strategy","cost_advantage","tam","sam","som","market_cagr"],"media":["chart_ecosystem"],"template_id":"product_v2"}'),
...
('v2','v2_card_05',5,'核心客户',
 '{"fields":["ideal_customer_profile","customer_segment_primary","customer_segment_secondary","retention_rate","paying_users"],"media":["product_main"],"template_id":"finance_v2"}'),
('v2','v2_card_06',6,'GTM与增长',
 '{"fields":["growth_strategy","gtm_motion","growth_flywheel","cac","ltv","ltv_cac_ratio"],"media":["flywheel"],"template_id":"gtm_v2"}'),
('v2','v2_card_07',7,'竞争格局',
 '{"fields":["competitors_summary","technical_barrier","switching_cost","score_defensibility","score_incumbent_attention"],"media":["chart_competitive"],"template_id":"competitive_v2"}');
